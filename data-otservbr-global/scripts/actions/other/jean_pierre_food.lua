...
condition_ml:setParameter(CONDITION_PARAM_SUBID, 4)
...
condition_melee:setParameter(CONDITION_PARAM_SUBID, 5)
...
condition_dist:setParameter(CONDITION_PARAM_SUBID, 6)
...
condition_f:setParameter(CONDITION_PARAM_SUBID, 6)
